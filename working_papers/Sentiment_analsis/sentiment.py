...
for article in articles['articles']:
   # if article['source']['name'] == 'Yahoo Entertainment' or article['source']['name'] == 'Motley Fool' or article['source']['name'] == 'PRNewswire' or article['source']['name'] == 'Biztoc.com'  or article['source']['name'] == 'TechCrunch' or article['source']['name'] == 'GlobeNewswire' or article['source']['name'] == 'MarketWatch' or article['source']['name'] == 'Fortune'  : # Check if the article is from specified sources
        articlenumber += 1
